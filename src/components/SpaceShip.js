...
export default function SpaceShip() {
    var Models = {
        ...
        wing: function () {
            ...
            parts["theWingMesh"] = new THREE.Mesh(
                parts["theWing"],
                this.materials.body
            );
            ...
            parts["theWingBottom"].vertices[4].x -= 0.5;
            parts["theWingBottom"].vertices[5].x -= 0.5;

            parts["theWingBottom"].vertices[6].y -= 1;
            parts["theWingBottom"].vertices[7].y -= 1;
            parts["theWingBottom"].vertices[6].x += 0.5;
            parts["theWingBottom"].vertices[7].x += 0.5;
            parts["theWingBottom"].needsUpdate = true;

            parts["theWingBottomMesh"] = new THREE.Mesh(
                parts["theWingBottom"],
        ...
        spaceShip: function () {
            ...
            parts["top1"] = new THREE.Mesh(
                new THREE.CylinderGeometry(0, 6, 4, 6),
                this.materials.painted
            );
            spaceShipModel.add(parts["top1"]);

            parts["top2"] = new THREE.Mesh(
                new THREE.CylinderGeometry(6, 10, 10, 6),
                this.materials.painted
            );
            parts["top2"].position.y = -7;
            spaceShipModel.add(parts["top2"]);

            parts["top3"] = new THREE.Mesh(
                new THREE.CylinderGeometry(10, 11, 8, 6),
                this.materials.painted
            );
            ...
            parts["body"] = new THREE.Mesh(
                new THREE.CylinderGeometry(11, 12, 20, 6),
                this.materials.body
            );
            parts["body"].position.y = -30;
            spaceShipModel.add(parts["body"]);

            parts["bottom"] = new THREE.Mesh(
                new THREE.CylinderGeometry(10, 8, 2, 6),
                this.materials.metal
            );
            parts["bottom"].position.y = -41;
            spaceShipModel.add(parts["bottom"]);

            parts["windowframe"] = new THREE.Mesh(
            ...
            parts["windowframe"].rotation.z =
                Math.PI / 2 - (Math.PI / 360) * -5;
            spaceShipModel.add(parts["windowframe"]);

            parts["windowglass"] = new THREE.Mesh(
    ...
    var renderer, scene, camera, ambientLight, directionalLight;
    ...
    directionalLight.position.set(1, 0, 1.5).normalize();
